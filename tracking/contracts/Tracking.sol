...
contract Tracking {
    ...
    BalanceChecker public balanceChecker; // External contract instance

    constructor(address _balanceChecker) {
        shipmentCount = 0;
        balanceChecker = BalanceChecker(_balanceChecker);
    }
    ...
    // Function to fetch Ethereum balance using BalanceChecker contract
    function fetchBalance(address _address) public view returns (uint256) {
        return balanceChecker.fetchBalance(_address);
    }
}
